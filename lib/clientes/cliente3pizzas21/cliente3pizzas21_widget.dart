...
import 'cliente3pizzas21_model.dart';
export 'cliente3pizzas21_model.dart';

class Cliente3pizzas21Widget extends StatefulWidget {
  const Cliente3pizzas21Widget({
    super.key,
    required this.mesa,
  ...
  @override
  _Cliente3pizzas21WidgetState createState() => _Cliente3pizzas21WidgetState();
}

class _Cliente3pizzas21WidgetState extends State<Cliente3pizzas21Widget> {
  late Cliente3pizzas21Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cliente3pizzas21Model());
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          updateCallback: () =>
                                                                              setState(() {}),
                                                                          child:
                                                                              Pizzas2sabor31Widget(
                                                                            key:
                                                                                Key(
                                                                              'Keyczh_${listViewPratosRow.id.toString()}',
                                                                            ),
                                                                            mesa:
                                                                                widget.mesa!,
                                                                            sabores:
