  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case GuarnicaoRow:
            return GuarnicaoRow(data);
          case GaronRow:
            return GaronRow(data);
          case EstabelecimentoRow:
            return EstabelecimentoRow(data);
          case SomaPedidoRow:
            return SomaPedidoRow(data);
          case PedidosRow:
            return PedidosRow(data);
          case ItensDoPedidoRow:
            return ItensDoPedidoRow(data);
          case HistricoRow:
            return HistricoRow(data);
          case PratosRow:
          ...
          case MesasRow:
            return MesasRow(data);
          case GaronsAtendimentoRow:
            return GaronsAtendimentoRow(data);
          default:
            return null;
        }
