...
class _E01user01WidgetState extends State<E01user01Widget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => E01user01Model());
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child:
                                      ...
                                      future:
                                          EstabelecimentoTable().querySingleRow(
                                        queryFn: (q) => q.eq(
                                          'id',
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return FFButtonWidget(
                                          onPressed: () async {
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                                            if (_model.textFieldSENController1
                                                    .text !=
                                                _model.textFieldSENController2
                                                    .text) {
                                            ...
                                            final user = await authManager
                                              ...
                                              context,
                                              _model.textFieldeMController.text,
                                              _model
                                                  .textFieldSENController1.text,
                                            );
                                            if (user == null) {
                                              return;
                                            }
                                            ...
                                            await Future.delayed(const Duration(
                                                milliseconds: 1000));
                                            _model.uSERcad = await SupabaseGroup
                                                .buscarUsuarioPorEmailCall
                                                .call(
                                              email: _model
                                                  .textFieldeMController.text,
                                            );
                                            await UsuariosTable().insert({
                                              ...
                                              'email': _model
                                                  .textFieldeMController.text,
                                              'restaurante_id':
                                                  buttonEstabelecimentoRow?.id,
                                              'tipo': _model.dropDownValue,
                                              'uid': SupabaseGroup
                                                  .buscarUsuarioPorEmailCall
                                                  .uid(
                                                (_model.uSERcad?.jsonBody ??
                                                    ''),
                                              ),
                                            });
                                            ScaffoldMessenger.of(context)
                                      ...
                                      child: FutureBuilder<List<UsuariosRow>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemCount:
                                                listViewUsuariosRowList.length,
                                            itemBuilder:
