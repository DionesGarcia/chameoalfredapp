                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child:
                                              FutureBuilder<List<GuarnicaoRow>>(
                                            future: (_model
                                                        .requestCompleter2 ??=
                                                    Completer<
                                                        List<GuarnicaoRow>>()
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                if (widget.refprato!.pizza!) {
                                                  await PratosTable().update(
                                                    data: {
                                                      'nome': _model
                                                          .textFieldSBController
                                                          .text,
