                                ...
                                children: [
                                  Align(
                                    ...
                                    child: FlutterFlowButtonTabBar(
                                      ...
                                      labelColor:
                                          FlutterFlowTheme.of(context).primaria,
                                      unselectedLabelColor: const Color(0x8057636C),
                                      backgroundColor:
                                      ...
                                      tabs: [
                                        FutureBuilder<List<PedidosRow>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<PedidosRow> tabPedidosRowList =
                                                snapshot.data!;
                                            return Tab(
                                              text:
                                      ...
                                      children: [
                                        FutureBuilder<List<PedidosRow>>(
                                          future: (_model.requestCompleter2 ??=
                                                  Completer<List<PedidosRow>>()
                                                    ..complete(PedidosTable()
                                                        .queryRows(
                                                      queryFn: (q) => q
                                                          .eq(
                                                            'status',
