...
class _UseroEditWidgetState extends State<UseroEditWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UseroEditModel());
                                      ...
                                      if (columnUsuariosRow?.imagem == null ||
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: Image.asset(
                                              'assets/images/perfil-de-usuario_(1).png',
                                              fit: BoxFit.fitWidth,
                                            ),
                                          ),
                                        ),
                                ...
                                onPressed: () async {
                                  await UsuariosTable().update(
                                    data: {
                                      ...
                                      'email': _model.cityController.text,
                                      'restaurante_id':
                                          widget.userID?.restauranteId,
                                      'tipo': _model.stateValue,
                                      'imagem': '',
                                    },
                                    matchingRows: (rows) => rows.eq(
                                      'id',
