...
class _E02EstabelecimentotrueWidgetState
    extends State<E02EstabelecimentotrueWidget> {
  late E02EstabelecimentotrueModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => E02EstabelecimentotrueModel());
