...
import 'sisestabelecimento_model.dart';
export 'sisestabelecimento_model.dart';

class SisestabelecimentoWidget extends StatefulWidget {
  const SisestabelecimentoWidget({
    super.key,
...
class _SisestabelecimentoWidgetState extends State<SisestabelecimentoWidget> {
  late SisestabelecimentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SisestabelecimentoModel());
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      FutureBuilder<List<AssinaturasRow>>(
                                        future:
                                            AssinaturasTable().querySingleRow(
                                          queryFn: (q) => q.eq(
                                            'restaurante_id',
                                            columnEstabelecimentoRow?.id,
                                          ),
