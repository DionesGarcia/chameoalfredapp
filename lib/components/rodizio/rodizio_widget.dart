...
import 'rodizio_model.dart';
export 'rodizio_model.dart';

class RodizioWidget extends StatefulWidget {
  const RodizioWidget({
    super.key,
    required this.mesa,
    required this.prato,
...
class _RodizioWidgetState extends State<RodizioWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RodizioModel());
