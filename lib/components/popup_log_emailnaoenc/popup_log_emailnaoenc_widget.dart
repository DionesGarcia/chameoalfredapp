...
class PopupLogEmailnaoencWidget extends StatefulWidget {
  ...
  @override
  State<PopupLogEmailnaoencWidget> createState() =>
      _PopupLogEmailnaoencWidgetState();
}

class _PopupLogEmailnaoencWidgetState extends State<PopupLogEmailnaoencWidget> {
  late PopupLogEmailnaoencModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopupLogEmailnaoencModel());
