...
import 'cliente_boton_vercarrinhoadm_model.dart';
export 'cliente_boton_vercarrinhoadm_model.dart';

class ClienteBotonVercarrinhoadmWidget extends StatefulWidget {
  const ClienteBotonVercarrinhoadmWidget({
    super.key,
...
class _ClienteBotonVercarrinhoadmWidgetState
    extends State<ClienteBotonVercarrinhoadmWidget> {
  late ClienteBotonVercarrinhoadmModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClienteBotonVercarrinhoadmModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.valor = (widget.cover!) +
            (widget.embalagem!) +
            (widget.garcom!) +
